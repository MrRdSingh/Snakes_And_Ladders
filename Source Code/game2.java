...
public class game2 extends javax.swing.JFrame {
    ...
    public game2() {
        ...
        show.setText(plyname + enter_in.ply1);
        show2.setText("COMPUTER" + enter_in.ply2);
    ...
    private void initComponents() {
        ...
        l_pic.setBounds(180, 0, 248, 310);

        computer.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        computer.setForeground(new java.awt.Color(0, 153, 153));
        computer.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        computer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/snake_game/folder/think-transparent.gif"))); // NOI18N
        computer.setText("Please wait...");
        getContentPane().add(computer);
        computer.setBounds(180, 380, 160, 60);

        press.setBackground(new java.awt.Color(0, 0, 255));
        press.setForeground(java.awt.Color.white);
        press.setText("Press Here");
        ...
        press.setBounds(230, 380, 100, 40);
        ...
        show2.setBounds(360, 330, 150, 30);
...
// TODO add your handling code here:
    ...
    private void pressActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pressActionPerformed
        ...
        ok.setVisible(true);
        press.setVisible(false);
        computer.setVisible(false);*/// TODO add your handling code here:
